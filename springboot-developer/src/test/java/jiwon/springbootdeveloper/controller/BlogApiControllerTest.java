...
import jiwon.springbootdeveloper.service.BlogService;
...
class BlogApiControllerTest {
    ...
    @Autowired
    protected ObjectMapper objectMapper; // 직렬/역직렬화. Django의 Serializer 같은 거라고 생각하면 되려나?
    ...
    @DisplayName("find Article: 블로그 글 조회에 성공한다.")
    @Test
